...
public class Leave extends UniversalActor  {
	public static void main(String args[]) {
		...
		Leave instance = (Leave)new Leave(uan, ual).construct();
		{
	...
	public Leave(boolean o, UAN __uan)	{ super(o,__uan); }
	public Leave(boolean o, UAL __ual)	{ super(o,__ual); }

	public Leave(UAN __uan)	{ this(__uan, null); }
	public Leave(UAL __ual)	{ this(null, __ual); }
	public Leave()		{ this(null, null);  }
	public Leave(UAN __uan, UAL __ual) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getReception().getLocation())) {
			createRemotely(__uan, __ual, "src.resources.Leave");
		} else {
					...
					if (ual.getIdentifier().equals("/io/protocolActor")) {
						{
							...
							{
								Object _arguments[] = {  };
								Message __message = new Message( self, new UniversalActor(ual), "leaveComputation", _arguments, null, token_5_0 );
