...
public class Tree extends UniversalActor  {
	public static void main(String args[]) {
		...
		Tree instance = (Tree)new Tree(uan, ual).construct();
		{
	...
	public Tree(boolean o, UAN __uan)	{ super(o,__uan); }
	public Tree(boolean o, UAL __ual)	{ super(o,__ual); }

	public Tree(UAN __uan)	{ this(__uan, null); }
	public Tree(UAL __ual)	{ this(null, __ual); }
	public Tree()		{ this(null, null);  }
	public Tree(UAN __uan, UAL __ual) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getReception().getLocation())) {
			createRemotely(__uan, __ual, "src.testing.reachability.Tree");
		} else {
						...
						if (bi_connected==1) {
							{
								...
								// protocolActor2<-addPeer(protocolActor1)
								{
									...
									Message __message = new Message( self, protocolActor2, "addPeer", _arguments, token_2_1, token_6_0 );
									__messages.add( __message );
								}
						...
						if (bi_connected==1) {
							{
								...
								{
									Object _arguments[] = { protocolActor1 };
									Message __message = new Message( self, protocolActor3, "addPeer", _arguments, token_2_1, token_6_0 );
									__messages.add( __message );
								}
