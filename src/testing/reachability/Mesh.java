...
public class Mesh extends UniversalActor  {
	public static void main(String args[]) {
		...
		Mesh instance = (Mesh)new Mesh(uan, ual).construct();
		{
	...
	public Mesh(boolean o, UAN __uan)	{ super(o,__uan); }
	public Mesh(boolean o, UAL __ual)	{ super(o,__ual); }

	public Mesh(UAN __uan)	{ this(__uan, null); }
	public Mesh(UAL __ual)	{ this(null, __ual); }
	public Mesh()		{ this(null, null);  }
	public Mesh(UAN __uan, UAL __ual) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getReception().getLocation())) {
			createRemotely(__uan, __ual, "src.testing.reachability.Mesh");
		} else {
