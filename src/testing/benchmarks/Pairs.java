...
public class Pairs extends UniversalActor  {
	public static void main(String args[]) {
		...
		Pairs instance = (Pairs)new Pairs(uan, ual).construct();
		{
	...
	public Pairs(boolean o, UAN __uan)	{ super(o,__uan); }
	public Pairs(boolean o, UAL __ual)	{ super(o,__ual); }

	public Pairs(UAN __uan)	{ this(__uan, null); }
	public Pairs(UAL __ual)	{ this(null, __ual); }
	public Pairs()		{ this(null, null);  }
	public Pairs(UAN __uan, UAL __ual) {
		if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getReception().getLocation())) {
			createRemotely(__uan, __ual, "src.testing.benchmarks.Pairs");
		} else {
