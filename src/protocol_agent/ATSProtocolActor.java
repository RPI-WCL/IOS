...
public class ATSProtocolActor extends UniversalActor  {
	public static void main(String args[]) {
		...
		ATSProtocolActor instance = (ATSProtocolActor)new ATSProtocolActor(uan, ual).construct();
		{
	...
	public ATSProtocolActor(boolean o, UAN __uan)	{ super(o,__uan); }
	public ATSProtocolActor(boolean o, UAL __ual)	{ super(o,__ual); }

	public ATSProtocolActor(UAN __uan)	{ this(__uan, null); }
	public ATSProtocolActor(UAL __ual)	{ this(null, __ual); }
	public ATSProtocolActor()		{ this(null, null);  }
	public ATSProtocolActor(UAN __uan, UAL __ual) {
	...
	public class State extends UniversalActor.State {
		...
		public ATSProtocolActor.State  _this = this;
		public State() {
			this(null, null);
		}
		...
		public void updateSelf(ActorReference actorReference) {
			self = (ATSProtocolActor)actorReference;
			self.setUAN(getUAN());
			self.setUAL(getUAL());
		...
		public void initiateSteal() {
			...
			waiting = true;
			{
				// propagateSteal(((ATSProtocolActor)self), new Double(profilingAgent.getAvailableProcessing()), profilingAgent.getActors(), new Integer(maxTTL))
				{
					Object _arguments[] = { ((ATSProtocolActor)self), new Double(profilingAgent.getAvailableProcessing()), profilingAgent.getActors(), new Integer(maxTTL) };
		...
		public void joinComputation(PeerServer peerServer) {
			...
			{
				// peerServer<-register(((ATSProtocolActor)self))
				{
					Object _arguments[] = { ((ATSProtocolActor)self) };
		...
		public void leaveComputation() {
			...
			for (int i = 0; i<peerServers.size(); i++){
				...
				{
					// target<-remove(((ATSProtocolActor)self))
					{
						Object _arguments[] = { ((ATSProtocolActor)self) };
			...
			if (neighbors==null||neighbors.size()==0) {
				...
				for (int i = 0; i<neighbors.size(); i++){
					...
					{
						// target<-leaveRequest(((ATSProtocolActor)self))
						{
							Object _arguments[] = { ((ATSProtocolActor)self) };
		...
		public void leaveRequest(ATSProtocolActor requester) {
			...
			if (profilingAgent.isComputing()) 			{
				// requester<-getActor(((ATSProtocolActor)self))
				{
					Object _arguments[] = { ((ATSProtocolActor)self) };
				...
				// requester<-notConnected(((ATSProtocolActor)self))
				{
					Object _arguments[] = { ((ATSProtocolActor)self) };
		...
		public void getActor(ATSProtocolActor requester) {
			if (unmigratedActors.size()>0) {
				...
				if (unmigratedActors.size()>0) 				{
					// requester<-leaveRequest(((ATSProtocolActor)self))
					{
						Object _arguments[] = { ((ATSProtocolActor)self) };
